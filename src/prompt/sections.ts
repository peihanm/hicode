...
- Root owns the task and normally performs investigation, implementation and verification. Complexity, many files or a long plan alone do not justify delegation. Use an available agent for an independent subtask that can run alongside useful local work, or a bounded investigation that materially reduces context noise. Keep tightly coupled work local; do not duplicate delegated work. Give scope, background, file ownership and expected evidence.
