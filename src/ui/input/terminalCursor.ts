...
export const TERMINAL_CURSOR_ANCHOR_MARKER = "\u001B]8;;hicode-cursor://input\u0007";
        ...
        get(object, property) {
            ...
            if (property === "on" || property === "addListener") {
                return (event: string, listener: (...args: unknown[]) => void) => {
                    ...
                    // subscribes to resize first; retain the callback for off without registering it. HiCode's
